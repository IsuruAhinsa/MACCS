                                ...
                                <td>
                                    <div class="btn-toolbar mb-2" role="toolbar" aria-label="Icons Toolbar with button groups">
                                        <div class="btn-group btn-group-sm mr-2 mb-2" role="group" aria-label="Icons File group">
                                            <a href="{{ route('appointments.edit', $record->id) }}" type="button" class="btn btn-primary {{ $record->is_canceled == true ? 'disabled' : '' }}">
                                                <i class="fa fa-fw fa-clock"></i>
                                            </a>
                                            <a href="{{ route('appointments.cancel', $record->id) }}" onclick="return confirm('Do you want to cancel? ')" type="button" class="btn btn-primary {{ $record->is_canceled == true ? 'disabled' : '' }}">
